...
import Requests from './AdminDashboardComponents/Requests.js'
...
export default function Dashboard() {
  ...
  const mainListItems = (
    <React.Fragment>
      ...
      <ListItemButton onClick={() => setDashboard('Requests')}>
        <ListItemIcon>
          <MedicalServicesIcon />
        </ListItemIcon>
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        >
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            ...
            {dashboardChoice === 'Requests' && <Requests setter={setDashboard}/>}
